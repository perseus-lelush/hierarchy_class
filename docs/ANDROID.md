...
> **Package:** `com.hierarchyclass.app` - **TWA build:** `1.15.90` (`versionCode 11590`, archived) - **Standalone build:** `1.30.1` (`versionCode 130001`) - **Web:** `1.30.1` (`package.json:version`)
