...
> **Package:** `com.hierarchyclass.app` - **TWA build:** `1.15.90` (`versionCode 11590`, archived) - **Standalone build:** `1.31.3` (`versionCode 131003`) - **Web:** `1.31.3` (`package.json:version`)
