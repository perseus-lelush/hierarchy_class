...
> **Package:** `com.hierarchyclass.app` - **TWA build:** `1.15.90` (`versionCode 11590`, archived) - **Standalone build:** `1.30.0` (`versionCode 130000`) - **Web:** `1.30.0` (`package.json:version`)
