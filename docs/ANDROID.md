...
> **Package:** `com.hierarchyclass.app` - **TWA build:** `1.15.90` (`versionCode 11590`, archived) - **Standalone build:** `1.31.2` (`versionCode 131002`) - **Web:** `1.31.2` (`package.json:version`)
