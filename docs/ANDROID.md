...
> **Package:** `com.hierarchyclass.app` - **TWA build:** `1.15.90` (`versionCode 11590`, archived) - **Standalone build:** `1.31.0` (`versionCode 131000`) - **Web:** `1.31.0` (`package.json:version`)
